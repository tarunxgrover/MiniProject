...
const EditProfile = () => {
    ...
    return (
        <div className="bg-gray-gainsboro">
                    ...
                    <table className="w-full" cellPadding={15}>
                        ...
                        <tr>
                            ...
                            <td className="absolute"><button
                                ...
                                className="w-44 mt-8 px-7 py-2 bg-indianred text-white-900 hover:bg-gray-light hover:text-indianred rounded-t rounded-b text-lg font-bold align-bottom"
                            >
                                {edit ? "Edit" : "Cancel"}
                            </button><br /><button
                                type="submit"
                                className={`w-44 mt-8 px-7 py-2 bg-indianred text-white-900 hover:bg-gray-light hover:text-indianred rounded-t rounded-b text-lg font-bold align-bottom ${edit && "hidden"}`}
                            >
                                    Save
                                </button></td>
                        </tr>
