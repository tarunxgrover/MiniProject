...
const Auth = (props) => {
    ...
    const s1 = "mx-2 px-9 py-2 font-semibold rounded-t rounded-b shadow-sm bg-indianred text-white-900 hover:text-indianred hover:bg-white-900 hover:drop-shadow-md hover:opacity-80 cursor-pointer";
    useEffect(() => {
    ...
    return (
        <div style={{minheight:"100%",height:"62rem"}} className="bg-purple dark:bg-gray-bg">
            <section className="flex justify-center items-center">
                <div className={`bg-gray-gainsboro rounded-xl p-6 w-${auth === 0 ? "10/12" : "4/12"} mt-5 drop-shadow-2xl pb-10 dark:drop-shadow-dark-2xl`}>
                    <form
                        className="space-y-7"
                        action=""
