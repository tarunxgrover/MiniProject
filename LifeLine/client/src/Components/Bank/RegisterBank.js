...
const RegisterBank = (props) => {
    ...
    const s1 = "mx-2 px-9 py-2 w-4/12 font-semibold  shadow-sm bg-indianred text-white-900 hover:bg-gray-light hover:text-indianred rounded-t rounded-b text-lg font-bold hover:drop-shadow-md hover:opacity-80 cursor-pointer";
